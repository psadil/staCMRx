...
% tolerance = gap proportion between upper and lower bound
% proc = no. of processors (default = -1, all of them)
% if proc=1 then no threading (therefore statistics are synchronous)
%
% returns:
